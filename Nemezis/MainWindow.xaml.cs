...
namespace Nemizisv2
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private string _PathLLVMMCexe
        {
            get { return Path.Combine(_FilesFolderPath, "llvm-mc.exe"); }
        }
        private string _PathInputFile
        {
            get { return Path.Combine(_FilesFolderPath, "tmpFile"); }
        }
